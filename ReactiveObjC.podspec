Pod::Spec.new do |s|
  ...
  s.subspec 'ios-base' do|sub|
    ...
    sub.ios.exclude_files = "ReactiveObjC/**/*{MK,UI,AppKit,NSControl,NSText,NSTable,NSFile,NSData,NSDictionary,NSEnumerator,NSInvocation,*KVO,NSArray+RACSequenceAdditions}*", "ReactiveObjC/**/{RACDelegateProxy,RACCommand,RACSelectorSignal,RACLifting,RACPropertySubscribing}.{h,m}"
  end
