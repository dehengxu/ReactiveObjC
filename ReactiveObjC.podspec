Pod::Spec.new do |s|
  ...
  s.subspec 'ios-base' do|sub|
    sub.source_files = "ReactiveObjC/**/ReactiveObjC*.{h,m,d}*", "ReactiveObjC/**/RAC*.{h,m,d}*", "ReactiveObjC/extobjc/*.{h,m}", "ReactiveObjC/**/{NSObject+RACDescription,NSObject+RACDeallocating,NSObject+RACSelectorSignal}*.{h,m,d}*"
