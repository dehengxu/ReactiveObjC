...
#if __has_include(<ReactiveObjC/NSArray+RACSequenceAdditions.h>)
...
#if __has_include(<ReactiveObjC/NSString+RACSequenceAdditions.h>)
...
#if __has_include(<ReactiveObjC/UIBarButtonItem+RACCommandSupport.h>)
